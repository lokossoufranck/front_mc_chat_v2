<template>
	<div id="layout-config" :class="containerClass">
		...
		<div class="layout-config-content">
			<h5 class="mt-0">Taille de l'ecran</h5>
			...
			<h5>Style des champs d'entrés</h5>
			<div class="p-formgroup-inline">
				<div class="field-radiobutton">
					...
					<label for="input_outlined">sans fond</label>
				</div>
				<div class="field-radiobutton">
					...
					<label for="input_filled">avec fond</label>
				</div>
			</div>
